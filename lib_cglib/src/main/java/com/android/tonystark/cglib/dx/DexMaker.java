...
package com.android.tonystark.cglib.dx;

import com.android.tonystark.cglib.dx.dex.DexFormat;
...
import com.android.tonystark.cglib.dx.dex.code.RopTranslator;
import com.android.tonystark.cglib.dx.dex.file.ClassDefItem;
import com.android.tonystark.cglib.dx.dex.file.DexFile;
import com.android.tonystark.cglib.dx.dex.file.EncodedField;
import com.android.tonystark.cglib.dx.dex.file.EncodedMethod;
import com.android.tonystark.cglib.dx.rop.code.AccessFlags;
...
public final class DexMaker {
    ...
    public Code declare(MethodId<?, ?> method, int flags) {
        ...
        if (method.isConstructor()) {
            flags |= AccessFlags.ACC_CONSTRUCTOR;
        }
    ...
    static class MethodDeclaration {
        ...
        boolean isDirect() {
            return (flags & (STATIC | PRIVATE | AccessFlags.ACC_CONSTRUCTOR)) != 0;
        }
